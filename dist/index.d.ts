...
export interface HecmFixedRouting {
    ...
    reason: 'pl_utilization_at_or_above_60' | 'pl_utilization_below_60' | 'unknown';
}
/**
 ...
 */
export type HecmContentType = 'FIELD_COACH_NOTE' | 'HECM_101_CARD' | 'OBJECTION' | 'COMPLIANCE_NOTE';
